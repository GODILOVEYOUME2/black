...
function run(msg, matches) 
	if matches[1]:lower() == "calc" and matches[2] or  matches[1]:lower() == "Calc" and matches[2] then 
...
--------------------------------
	if matches[1]:lower() == 'praytime' or matches[1] == 'azan' or  matches[1]:lower() == 'Praytime' or matches[1] == 'Azan' then
		if matches[2] then
			city = matches[2]
...
--------------------------------
	if matches[1]:lower() == 'tophoto' and msg.reply_id  or matches[1]:lower() == 'Tophoto' and msg.reply_id then
...
--------------------------------
	if matches[1]:lower() == 'tosticker' and msg.reply_id  or  matches[1]:lower() == 'Tosticker' and msg.reply_id then
...
--------------------------------
	if matches[1]:lower() == 'weather' or matches[1]:lower() == 'Weather' then
		city = matches[2]
...
--------------------------------
	if matches[1]:lower() == 'time' or matches[1]:lower() == 'Time' then
...
--------------------------------
if matches[1] == 'voice' or matches[1] == 'Voice' then
 ...
 --------------------------------
	if matches[1] == "tr" or matches[1] == "Tr" then 
		url = https.request('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160119T111342Z.fd6bf13b3590838f.6ce9d8cca4672f0ed24f649c1b502789c9f4687a&format=plain&lang='..URL.escape(matches[2])..'&text='..URL.escape(matches[3]))
		data = json:decode(url)
		return 'زبان : '..data.lang..'\nترجمه : '..data.text[1]..'\n____________________\n @MahDiRoO :)'
	end
--------------------------------
	if matches[1]:lower() == 'short' or matches[1]:lower() == 'Short' then
...
--------------------------------
	if matches[1]:lower() == "sticker" or matches[1]:lower() == "Sticker" then 
...
--------------------------------
	if matches[1]:lower() == "photo" or  matches[1]:lower() == "Photo" then 
		local eq = URL.escape(matches[2])
		local w = "500"
		local h = "500"
		local txtsize = "100"
...
--------------------------------
if matches[1] == "helpfun" or matches[1] == "Helpfun" then
local hash = "gp_lang:"..msg.to.id
local lang = redis:get(hash)
if not lang then
helpfun = [[
_MaTaDoR Fun Help Commands:_
